...
class Customer(models.Model):
    ...
    imageCustomer = models.ImageField ( upload_to='media', blank=True, null=True, default='customer.png' )
...
class Car(models.Model):
    ...
    imageCar = models.ImageField ( upload_to='media', blank=True, null=True, default='car.png' )
