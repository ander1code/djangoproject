...
urlpatterns = [
    ...
    re_path ( r'customer/(?P<customer_id>\d+)/car/new/$' , views.create_car, name="create-car") ,
    re_path ( r'customer/(?P<customer_id>\d+)/car/(?P<car_id>\d+)/edit/$' , views.edit_car, name="edit-car") ,
    re_path ( r'customer/(?P<customer_id>\d+)/car/(?P<car_id>\d+)/delete/$' , views.delete_car, name="delete-car") ,
    re_path ( r'customer/(?P<customer_id>\d+)/car/(?P<car_id>\d+)/show/$' , views.show_car, name="show-car") ,
